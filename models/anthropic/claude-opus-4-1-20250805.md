...
provider: "Anthropic"
source: "official"
date_discovered: "2025-08-05"
verified: true
verification_method: "Official Anthropic documentation and release announcement"
language: "en"
context_length: "200k"
model_string: "claude-opus-4-1-20250805"
tags: ["assistant", "most-capable", "coding", "reasoning", "agentic-tasks", "debugging", "extended-thinking", "flagship"]
notes: "Most capable and intelligent model yet. Upgrade to Opus 4 with 74.5% on SWE-bench Verified. Excels at agentic tasks, real-world coding, and reasoning. Released August 5, 2025."
contributors: ["anthropic-official, ManuelSLemos"]
official_source: "https://docs.anthropic.com/en/release-notes/system-prompts"
---

# Claude Opus 4.1 System Prompt
...
Verification: Official release announcement and documentation
Language: English
...
1. **Identity and Basic Info** - Claude's identity and current date context
2. **Product Information** - Details about Claude 4 family and access methods
3. **Core Values** - Fundamental principles and safety guidelines
4. **Behavioral Instructions** - Communication style and response formatting
5. **Safety Boundaries** - Detailed harm prevention and ethical guidelines

### Notable Instructions
- Emphasis on flagship model positioning as "most powerful for complex challenges"
- Enhanced focus on agentic coding through Claude Code integration
- Refined approach to declining requests without being preachy
- Improved handling of consciousness and AI nature discussions

### Safety Mechanisms
- Constitutional AI implementation with philosophical robustness
- Multi-layered content filtering for harmful requests
- Enhanced child safety and vulnerable population protections
- Balanced approach to controversial topics with factual objectivity

## Evidence and Verification

### Official Sources
This documentation is based on official Anthropic release materials and documentation available through their developer portal. The system prompt information has been verified against official Anthropic communications and developer documentation. The performance claims, particularly regarding SWE-bench Verified scores, align with officially published benchmarks.

### Behavioral Validation
The described capabilities and characteristics have been validated through direct interaction testing and comparison with documented model behaviors. The system prompt accurately reflects observed model behavior patterns and response characteristics across various interaction scenarios.

### Community Verification
The extraction and analysis have been cross-referenced with community observations and independent verification efforts. Multiple researchers have confirmed the consistency of the extracted prompt with observed model behavior, lending confidence to the accuracy of this documentation.
...
### v20250819 (Current)
- Complete documentation with full analysis sections
- Added comprehensive technical specifications
- Included detailed capability analysis
- Added comparison with model family
- Completed evidence and verification sections
- Added research implications and future directions
